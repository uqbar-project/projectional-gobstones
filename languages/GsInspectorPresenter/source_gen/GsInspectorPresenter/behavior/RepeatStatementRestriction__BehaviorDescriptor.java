...
public final class RepeatStatementRestriction__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x329ed8d6630b448dL, 0xb0add0e71fe3ca82L, 0x2cebf908925c67cdL, "GsInspectorPresenter.structure.RepeatStatementRestriction");
  ...
  /*package*/ static boolean isRestricted_id5f2KzShMWtb(@NotNull SNode __thisNode__, SNode node) {
    return SNodeOperations.isInstanceOf(node, MetaAdapterFactory.getConcept(0xcb8c78e791643a8L, 0x8d8ea292ead7a894L, 0x379454b04a7864c4L, "MPSGobstones.structure.RepeatStatement"));
  }

  /*package*/ RepeatStatementRestriction__BehaviorDescriptor() {
    super(REGISTRY);
  }
