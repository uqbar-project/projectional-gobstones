...
public final class WhileStatementRestriction__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x329ed8d6630b448dL, 0xb0add0e71fe3ca82L, 0x53c2c23e11cbc92bL, "GsInspectorPresenter.structure.WhileStatementRestriction");
  ...
  /*package*/ static boolean isRestricted_id5f2KzShMWtb(@NotNull SNode __thisNode__, SNode node) {
    return SNodeOperations.isInstanceOf(node, MetaAdapterFactory.getConcept(0xcb8c78e791643a8L, 0x8d8ea292ead7a894L, 0x379454b04a788182L, "MPSGobstones.structure.WhileStatement"));
  }

  /*package*/ WhileStatementRestriction__BehaviorDescriptor() {
    super(REGISTRY);
  }
