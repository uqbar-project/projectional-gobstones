...
public final class False__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xcb8c78e791643a8L, 0x8d8ea292ead7a894L, 0xa107f9943a81181L, "MPSGobstones.structure.False");
  ...
  /*package*/ static InterpreterValue reduce_id2AtX8Dq04bG(@NotNull SNode __thisNode__, InterpreterState state) {
    return InterpreterConstants.FALSE;
  }

  /*package*/ False__BehaviorDescriptor() {
    super(REGISTRY);
  }
