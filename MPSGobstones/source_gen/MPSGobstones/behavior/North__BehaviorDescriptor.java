...
public final class North__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xcb8c78e791643a8L, 0x8d8ea292ead7a894L, 0x2ab0def7b5614f40L, "MPSGobstones.structure.North");
  ...
  /*package*/ static InterpreterValue reduce_id2AtX8Dq04bG(@NotNull SNode __thisNode__, InterpreterState state) {
    return InterpreterConstants.NORTH;
  }

  /*package*/ North__BehaviorDescriptor() {
    super(REGISTRY);
  }
