...
public final class ParenthesisExpression__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xcb8c78e791643a8L, 0x8d8ea292ead7a894L, 0x618424b489a40ba1L, "MPSGobstones.structure.ParenthesisExpression");
  ...
  /*package*/ static InterpreterValue reduce_id2AtX8Dq04bG(@NotNull SNode __thisNode__, InterpreterState state) {
    return (InterpreterValue) Expression__BehaviorDescriptor.reduce_id2AtX8Dq04bG.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0xcb8c78e791643a8L, 0x8d8ea292ead7a894L, 0x618424b489a40ba1L, 0x618424b489a40ba2L, "contained")), state);
  }

  /*package*/ ParenthesisExpression__BehaviorDescriptor() {
    super(REGISTRY);
  }
