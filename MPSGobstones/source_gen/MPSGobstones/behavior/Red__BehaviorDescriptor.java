...
public final class Red__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xcb8c78e791643a8L, 0x8d8ea292ead7a894L, 0x2ab0def7b5610a45L, "MPSGobstones.structure.Red");
  ...
  /*package*/ static InterpreterValue reduce_id2AtX8Dq04bG(@NotNull SNode __thisNode__, InterpreterState state) {
    return InterpreterConstants.RED;
  }

  /*package*/ Red__BehaviorDescriptor() {
    super(REGISTRY);
  }
